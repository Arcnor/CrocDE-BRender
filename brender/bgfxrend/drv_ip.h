 ...
 */
#ifndef BRENDERSAMPLE_DRV_IP_H
#define BRENDERSAMPLE_DRV_IP_H
 ...
 * rendfcty.cpp
 */
br_renderer_facility *RendererFacilityBGFXInit(br_device *dev);
...
/*
 * Wrappers for br_device_bgfx_procs.
 */
