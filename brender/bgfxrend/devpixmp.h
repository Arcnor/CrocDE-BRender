...
typedef struct {
    ...
    float r, g, b;
    float u, v;
} br_device_pixelmap_bgfx_tri;

typedef struct br_device_pixelmap_bgfx_quad {
    br_device_pixelmap_bgfx_tri tris[4];
//    GLuint                    defaultVao;
//    GLuint                    textVao;
//    GLuint                    buffers[2];
} br_device_pixelmap_bgfx_quad;
...
//            GLfloat                   clearColour[4];
            ...
            br_device_pixelmap_bgfx_quad quad;
        } asBack;
        struct {
